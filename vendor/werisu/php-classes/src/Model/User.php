    ...
    public static function getForgot($email, $inadmin = true)
	{
		...
		else
		{
			...
			else
			{
				...
				if ($inadmin === true) {
                    echo "<br>inadmin = true";
					$link = "http://www.wellysson.com.br/admin/forgot/reset?code=$code";

				} else {
                    echo "inadmin = false";
					$link = "http://www.wellysson.com.br/forgot/reset?code=$code";
					
                }
                
                // debug
                echo "<br><br>Desemail: ". $data['desemail']." - Desperson: " .$data['desperson']."<br>";
                echo $link."<br>";
                // debug
